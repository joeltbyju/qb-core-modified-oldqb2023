...
CreateThread(function()
	...
	if Config.Standalone then
		...
		-- Added For AIVP
		BusCheck = function(business)
			if type(business) == 'table' then
				business = business[PlayerData.business.name]
				if business and PlayerData.business.grade.level >= business then
					return true
				end
			elseif business == 'all' or business == PlayerData.business.name then
				return true
			end
			return false
		end
		...
		RegisterNetEvent('QBCore:Server:OnBusinessUpdate', function(BusinessInfo)
			PlayerData.business = BusinessInfo
		end)
...
function CheckOptions(data, entity, distance)
	...
	if data.business and not BusCheck(data.business) then return false end
