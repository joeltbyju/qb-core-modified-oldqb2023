const Targeting = Vue.createApp({
    data() {
        return {
            ...
            StandardEyeIcon: "far  fa-eye", // This is the default eye icon<i class="fa-solid fa-hand-sparkles"></i>
            CurrentIcon: this.StandardEyeIcon, // leave this
            SuccessColor: "rgb(245, 40, 0)", // This is the color when the target has found the option
