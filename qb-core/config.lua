...
QBConfig.Money = {}
QBConfig.Money.MoneyTypes = { cash = 50000, bank = 100000, crypto = 0 } -- type = startamount - Add or remove money types for your server (for ex. blackmoney = 0), remember once added it will not be removed from the database!
...
QBConfig.Server.ClosedReason =
"Server Closed"                                                  -- Reason message to display when people can't join the server
...
QBConfig.Server.Permissions = { 'god', 'admin', 'mod', 'staff' } -- Add as many groups as you want here after creating them in your server.cfg
